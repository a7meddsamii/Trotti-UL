...
class OrderApplicationServiceTest {
    ...
    void givenOngoingOrder_whenAddItem_thenItemAddedAndOrderSaved() {
        ...
        Mockito.when(orderRepository.findOngoingOrderFor(BUYER_ID))
                .thenReturn(Optional.of(existingOrder));
        Mockito.when(orderItemFactory.create(addItemDto.maximumDailyTravelTime(),
                addItemDto.session(), addItemDto.billingFrequency()))
                .thenReturn(Mockito.mock(RidePermitItem.class));
