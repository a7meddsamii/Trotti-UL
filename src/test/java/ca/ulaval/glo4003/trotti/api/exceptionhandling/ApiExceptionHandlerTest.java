...
class ApiExceptionHandlerTest {
    ...
    private static final InvalidParameterException EXCEPTION =
            new InvalidParameterException(ERROR_TYPE, ERROR_MESSAGE);
    ...
    void givenInvalidParameterException_whenToResponse_thenReturnJsonContentType() {
        assertEquals(EXPECTED_CONTENT_TYPE, response.getHeaderString(CONTENT_TYPE_HEADER));
    }
