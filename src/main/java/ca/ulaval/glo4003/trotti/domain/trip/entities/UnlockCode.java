...
public class UnlockCode {
    ...
    private UnlockCode(String code, Instant expiresAt, RidePermitId ridePermitId, Clock clock) {
        this.code = code;
    ...
    public static UnlockCode generateFromRidePermit(RidePermitId id, Clock clock) {
