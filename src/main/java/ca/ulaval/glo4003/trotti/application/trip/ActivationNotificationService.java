...
public class ActivationNotificationService {
   ...
   public ActivationNotificationService( TravelerRepository travelerRepository, RidePermitTranslator ridePermitTranslator){
   ...
   public void updateTravelersPermits(){
       ...
       travelers.forEach( traveler -> {
          List<RidePermit> boughtRidePermits = ridePermitTranslator.findByIdul(traveler.getIdul());
