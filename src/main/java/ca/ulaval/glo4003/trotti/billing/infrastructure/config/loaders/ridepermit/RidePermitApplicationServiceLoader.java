...
public class RidePermitApplicationServiceLoader extends Bootstrapper {
    ...
    private void loadRidePermitActivationApplicationService() {
        RidePermitAssembler ridePermitAssembler =
                this.resourceLocator.resolve(RidePermitAssembler.class);
        RidePermitRepository ridePermitRepository =
                this.resourceLocator.resolve(RidePermitRepository.class);
        RidePermitActivationFilter ridePermitActivationFilter =
                this.resourceLocator.resolve(RidePermitActivationFilter.class);
        ...
        RidePermitActivationApplicationService ridePermitActivationApplicationService =
                new RidePermitActivationApplicationService(ridePermitAssembler,
                        ridePermitRepository, ridePermitActivationFilter, eventBus);
    ...
    private void loadRidePermitApplicationService() {
        ...
        RidePermitApplicationService ridePermitApplicationService =
                new RidePermitApplicationService(ridePermitFactory, ridePermitRepository,
                        paymentGateway, ridePermitAssembler, clock);
        this.resourceLocator.register(RidePermitApplicationService.class,
                ridePermitApplicationService);
    }
}
