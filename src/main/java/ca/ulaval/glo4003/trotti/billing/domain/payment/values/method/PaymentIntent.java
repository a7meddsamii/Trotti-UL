...
public class PaymentIntent {
	...
	private PaymentIntent(Idul buyerId, OrderId orderId, Money amount, PaymentMethod method, boolean useSavedInfo) {
	...
	public static PaymentIntent of(Idul buyerId, OrderId orderId, Money amount, PaymentMethod method, boolean useSavedInfo) {
