...
public class RidePermitController implements RidePermitResource {
    ...
    public Response getRidePermits(Idul userId) {
        ...
        List<RidePermitResponse> ridePermitResponseList =
                ridePermitApiMapper.toRidePermitResponseList(ridePermitDtoList);
    ...
    public Response getRidePermit(Idul userId, String ridePermitId) {
        RidePermitDto ridePermitDto =
                ridePermitApplicationService.getRidePermit(userId, RidePermitId.from(ridePermitId));

        RidePermitResponse ridePermitResponse =
                ridePermitApiMapper.toRidePermitResponse(ridePermitDto);
