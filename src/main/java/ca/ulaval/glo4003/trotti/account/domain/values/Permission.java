...
public enum Permission {
    ORDER_CONFIRM, CART_MODIFICATION, MAKE_TRIP, START_MAINTENANCE, END_MAINTENANCE, RELOCATE_SCOOTER,
    REQUEST_MAINTENANCE, CREATE_EMPLOYEE, DELETE_EMPLOYEE, CREATE_ADMIN, DELETE_ADMIN;
