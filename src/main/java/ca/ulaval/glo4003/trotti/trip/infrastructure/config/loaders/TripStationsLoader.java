...
public class TripStationsLoader extends Bootstrapper {
    ...
    public void load() {
        StationDataFactory stationDataFactory = new StationDataFactory(
                this.resourceLocator.resolve(StationFactory.class), this.resourceLocator.resolve(ScooterFactory.class),
                this.resourceLocator.resolve(StationRepository.class), this.resourceLocator.resolve(ScooterRepository.class), this.resourceLocator.resolve(Clock.class));
