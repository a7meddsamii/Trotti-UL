...
public class TripGatewayEntryLoader extends Bootstrapper {
    ...
    private void loadStationOperationEntry() {
        ...
        StationOperationEntry stationOperationEntry =
                new StationOperationEntry(dockingAndUndockingApplicationService, stationApiMapper);
    ...
    private void loadGatewayApplicationServices() {
        ...
        DockingAndUndockingApplicationService dockingAndUndockingApplicationService =
                new DockingAndUndockingApplicationService(stationRepository, scooterRepository,
                        clock);
        this.resourceLocator.register(DockingAndUndockingApplicationService.class,
