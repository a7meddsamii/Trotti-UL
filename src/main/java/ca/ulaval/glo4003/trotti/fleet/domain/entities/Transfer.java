...
public class Transfer {
    ...
    public Transfer(TransferId transferId, Idul technicianId, Map<ScooterId, Boolean> scootersTransferCompletedState) {
    ...
    public List<ScooterId> unload(Idul technicianId, int numberOfScooters) {
        ...
        List<ScooterId> scootersToDeposit = getRemainingScootersToMove().subList(0, numberOfScooters);
