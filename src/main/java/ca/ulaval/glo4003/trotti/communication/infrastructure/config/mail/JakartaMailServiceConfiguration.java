package ca.ulaval.glo4003.trotti.communication.infrastructure.config.mail;
...
public class JakartaMailServiceConfiguration {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(JakartaMailServiceConfiguration.class);
    ...
    private JakartaMailServiceConfiguration(
            String username,
            String password,
            String host,
            String port) {
    ...
    public static JakartaMailServiceConfiguration create(String username, String password,
